...
/datum/experiment/scanning/points/Banana// = 770,
	...
	required_points = 1
	required_atoms = list(
		/obj/item/food/grown/bananna = 1,)
/datum/experiment/scanning/points/Berry// = 770,
	name = "Botany: Berry"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/obj/item/food/grown/berry = 1,)
...
/datum/experiment/scanning/points/Cherry// = 770,
	...
	required_points = 1
	required_atoms = list(
		/obj/item/food/grown/cherry = 1,)
/datum/experiment/scanning/points/Cocoa// = 770,
	name = "Botany: Cocoa"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/obj/item/food/grown/cocoa = 1,)
...
//*********chemistry*********
//easychem/
/datum/experiment/scanning/points/chem/Seiver// = 725,
	name = "Chemistry: Seiver"
	description = "Seiver"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/c2/seiver = 1,)
/datum/experiment/scanning/points/chem/Helbital// = 725,
	name = "Chemistry: Helbital"
	description = "Helbital"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/c2/helbital = 1,)
/datum/experiment/scanning/points/chem/Calomel// = 725,
	name = "Chemistry: Calomel"
	description = "Calomel"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/calomel = 1,)
/datum/experiment/scanning/points/chem/Mannitol// = 725,
	name = "Chemistry: Mannitol"
	description = "Mannitol"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/mannitol = 1,)
/datum/experiment/scanning/points/chem/Oil// = 725,
	name = "Chemistry: Oil"
	description = "Oil"
	required_points = 1
	required_atoms = list(
		/datum/reagent/fuel/oil = 1,)
/datum/experiment/scanning/points/chem/PotassiumIodide// = 725,
	name = "Chemistry: Potassium Iodide"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/potass_iodide = 1,)
/datum/experiment/scanning/points/chem/Synaptizine// = 725,
	name = "Chemistry: Synaptizine"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		datum/reagent/medicine/synaptizine = 1,)
/datum/experiment/scanning/points/chem/SpaceDrugs// = 725,
	name = "Chemistry: Space Drugs"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/drug/space_drugs = 1,)
/datum/experiment/scanning/points/chem/Cryptobiolin// = 725,
...
//mediumchem/
/datum/experiment/scanning/points/chem/Mutadone// = 1450,
	name = "Chemistry: Mutadone"
	description = "Mutadone"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/mutadone = 1,)
/datum/experiment/scanning/points/Candle// = 1450,
	...
	required_atoms = list(
		fillout = 1,)
/datum/experiment/scanning/points/chem/Oculine// = 1450,
	name = "Chemistry: Oculine"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/oculine = 1,)
/datum/experiment/scanning/points/chem/Diphenhydramine// = 1450,
	name = "Chemistry: Diphenhydramine"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/diphenhydramine = 1,)
/datum/experiment/scanning/points/chem/Ephedrine// = 1450,
	name = "Chemistry: Ephedrine"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/ephedrine = 1,)
/datum/experiment/scanning/points/chem/Neurine// = 1450,
	name = "Chemistry: Neurine"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/neurine = 1,)
/datum/experiment/scanning/points/chem/Lidocaine// = 1450,
...
/datum/experiment/scanning/points/MeatProduct// = 1450,
	...
	required_atoms = list(
		fillout = 1,)
/datum/experiment/scanning/points/chem/Cryoxadone// = 1450,
	name = "Chemistry: Cryoxadone"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/cryoxadone = 1,)
/datum/experiment/scanning/points/chem/Lipolicide// = 1450,
	name = "Chemistry: Lipolicide"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/toxin/lipolicide = 1,)
//hardchem/
/datum/experiment/scanning/points/chem/StrangeReagent// = 2175,
	name = "Chemistry: Strange Reagent"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		fillout = 1,)
/datum/experiment/scanning/points/chem/Epinephrine// = 2175,
	name = "Chemistry: Epinephrine"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/strange_reagent = 1,)
/datum/experiment/scanning/points/chem/Modafinil// = 2175,
	name = "Chemistry: Modafinil"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		/datum/reagent/medicine/modafinil = 1,)
/datum/experiment/scanning/points/chem/Rotatium// = 2175,
	name = "Chemistry: Cryoxadone"
	description = "fillout"
	required_points = 1
	required_atoms = list(
		fillout = 1,)
/datum/experiment/scanning/points/chem/BathSalts// = 2175,
